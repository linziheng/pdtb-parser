...
public class SpanTreeExtractor {
  ...
  public static void main(String[] args) throws IOException {
    ...
    // expSpansGen(Settings.PTB_SHARED_TASK_TREE_PATH, Settings.PDTB_PATH);
    // textToSpanSharedTask(Settings.PTB_SHARED_TASK_TREE_PATH);
  ...
  private static void sharedTaskSpanGen(File treeFile) throws IOException {
    ...
    Reader r =
        new BufferedReader(new InputStreamReader(new FileInputStream(treeFile), Util.ENCODING));
    ...
    for (String topFolder : topFolders) {
      ...
      for (File file : files) {
        ...
        try (BufferedReader reader =
            new BufferedReader(new InputStreamReader(new FileInputStream(pdtbPath + fileName),
                Util.ENCODING))) {
          String line;
        ...
        for (File file : files) {
          ...
          while (root != null) {
            ...
            for (Tree leaf : leaves) {
              ...
              // skipping dots after U.S. present in the parse trees but not present in the original
              // text
              if (word.equals(".")) {
